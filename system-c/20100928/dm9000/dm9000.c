...
#else// XXX: for Real6410 platform
#define DM9000_IRQ_FLAGS	(IRQF_SHARED | IRQF_TRIGGER_HIGH)
#endif
...
dm9000_init_dm9000(struct net_device *dev)
{
	...
	/* GPIO0 on pre-activate PHY 启动PHY*/
...
dm9000_phy_read(struct net_device *dev, int phy_reg_unused, int reg)
{
	...
	while(ior(db, DM9000_EPCR)&0x1);	/* Wait read complete */
...
//在 linux 设备驱动中，有一类设备被称为"平台设备"， 通常 SoC 系统中集成的独立的 外设单元 都被当作平台设备处理
//平台设备用 platform_device 结构体来描述
//struct platform_device
//{ 	const char * name; //设备名
//	u32 id;
//	struct device dev;
//	u32	num_resources; //设备所使用的各类资源数量
//	struct resource * resourse; //资源
//}
